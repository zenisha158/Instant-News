...
xhr.open('GET',`https://newsapi.org/v2/top-headlines?category=entertainment&apiKey=4d39917902cf48a89578da6000dd02aa`,true);
...
xhr.onload = function () {
    if (this.status === 200) {
        ...
        articles.forEach(function(element, index) {
            let news=`<div class="card mb-3" style="background:url(entertainment.jpg);max-width: 900px; margin-left: 10%;margin-right: 10%;border-radius:15px; background-repeat:no-repeat; background-size: cover; background-position:center;">
            <div class="row g-0">
